...
- **Frontend**: `frontend/src/app/page.tsx` (supported by `frontend/src/components/DashboardCharts.tsx`, `frontend/src/components/TimesheetGrid.tsx`, `frontend/src/components/IssueDrilldownPanel.tsx`, and `frontend/src/components/AuthorFilter.tsx`)
